...
len1.addEventListener("change",myResult);
len2.addEventListener("change",myResult);
wei1.addEventListener("change",myResult);
wei2.addEventListener("change",myResult);
tem1.addEventListener("change",myResult);
tem2.addEventListener("change",myResult);
...
function myResult(){
    ...
    }else if(wei1Value == wei2Value){
        result.value = num.value;
    }else if(tem1Value == tem2Value){
        result.value = num.value;
    }
